...
public sealed class TypedValueTests(TwoNodeFixture fixture) : MultiNodeTestBase(fixture)
{
    ...
    public async Task GetOrAddShouldStoreCustomRecordForRemoteOwnerAcrossTwoNodes()
    {
        ...
        var key = MultiNodeSupport.FindKeyOwnedBy("orders", "nodeB", "typed-remote-get-or-add");
    ...
    {
        var cluster = await GetNamedCachesAsync<TypedCustomerProfile>();
        var key = MultiNodeSupport.FindKeyOwnedBy("orders", "nodeA", "typed-local-record");
        var expected = TypedValueFactory.CreateProfile(key);
    ...
    {
        var cluster = await GetNamedCachesAsync<TypedCustomerProfile>();
        var key = MultiNodeSupport.FindKeyOwnedBy("orders", "nodeB", "typed-remote-record");
        var expected = TypedValueFactory.CreateProfile(key);
    ...
    {
        var cluster = await GetNamedCachesAsync<TypedCustomerProfile>();
        var key = MultiNodeSupport.FindKeyOwnedBy("orders", "nodeB", "typed-remote-remove");
    ...
    {
        var cluster = await GetNamedCachesAsync<TypedCustomerProfile>();
        var nodeAKey = MultiNodeSupport.FindKeyOwnedBy("orders", "nodeA", "typed-mixed-record-a");
        var nodeBKey = MultiNodeSupport.FindKeyOwnedBy("orders", "nodeB", "typed-mixed-record-b");
    ...
    public async Task SetAndGetShouldRoundTripMutableClassAcrossTwoNodes()
    {
        ...
        var nodeAKey = MultiNodeSupport.FindKeyOwnedBy("orders", "nodeA", "typed-mixed-cart-a");
        var nodeBKey = MultiNodeSupport.FindKeyOwnedBy("orders", "nodeB", "typed-mixed-cart-b");
    ...
    {
        var cluster = await GetNamedCachesAsync<TypedCustomerProfile>();
        var key = MultiNodeSupport.FindKeyOwnedBy("orders", "nodeB", "typed-remote-update");
