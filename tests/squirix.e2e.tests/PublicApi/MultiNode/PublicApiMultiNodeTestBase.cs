...
public abstract class PublicApiMultiNodeTestBase : TestBase, IClassFixture<TwoNodeFixture>
{
    private readonly TwoNodeFixture _fixture;

    /// <summary>
    /// Initializes a new instance of the <see cref="PublicApiMultiNodeTestBase" /> class.
    /// </summary>
    /// <param name="fixture">Shared two-node cluster fixture.</param>
    protected PublicApiMultiNodeTestBase(TwoNodeFixture fixture) => _fixture = fixture ?? throw new ArgumentNullException(nameof(fixture));
