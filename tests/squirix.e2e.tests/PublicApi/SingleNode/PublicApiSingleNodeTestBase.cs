...
public abstract class PublicApiSingleNodeTestBase : TestBase, IClassFixture<SingleNodeFixture>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PublicApiSingleNodeTestBase" /> class.
    /// </summary>
    /// <param name="fixture">Shared single-node cluster fixture.</param>
    protected PublicApiSingleNodeTestBase(SingleNodeFixture fixture) => _fixture = fixture ?? throw new ArgumentNullException(nameof(fixture));
