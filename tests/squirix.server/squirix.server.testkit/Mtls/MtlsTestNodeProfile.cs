...
public enum MtlsTestNodeProfile
{
    ...
    /// <summary>Outbound cluster calls present a client certificate signed by an untrusted test CA.</summary>
    UntrustedOutboundClientCertificate = 2,

    /// <summary>The internal mTLS listener presents a server certificate signed by an untrusted test CA.</summary>
    UntrustedInboundServerCertificate = 3,

    /// <summary>The node certificate is expired but still chains to the cluster test CA.</summary>
