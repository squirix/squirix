...
public abstract class SmokeTestBase : IDisposable
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var cluster = TestCluster<SmokeStartOptions>.Create(
            topology,
            (self, nodeTopology, options, token) => StartClusterNodeAsync(self.Uri, ClusterIdentity.CreatePeers(nodeTopology, ref _identity), options, token),
            peers);
