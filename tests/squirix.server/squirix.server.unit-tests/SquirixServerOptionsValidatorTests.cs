...
public sealed class SquirixServerOptionsValidatorTests
{
    ...
    public void JsonDeserializationPopulatesPeers()
    {
        ...
        var options = JsonSerializer.Deserialize<SquirixServerOptions>(json, JsonOptions)
    ...
    {
        var options = new SquirixServerOptions();
        options.Peers.Add(new SquirixServerPeerOptions { NodeId = "other", Url = new Uri("https://localhost:5002") });
    ...
    public void DuplicatePeerNodeIdIsRejected()
    {
        ...
        options.Peers.Add(new SquirixServerPeerOptions { NodeId = "node-a", Url = new Uri("https://localhost:5002") });
    ...
    public void DuplicatePeerUrlIsRejected()
    {
        var options = new SquirixServerOptions { NodeId = "node-a", Url = new Uri("https://localhost:5001") };
        options.Peers.Add(new SquirixServerPeerOptions { NodeId = "node-a", Url = new Uri("https://localhost:5001") });
        options.Peers.Add(new SquirixServerPeerOptions { NodeId = "node-b", Url = new Uri("https://localhost:5001") });
    ...
    {
        var options = new SquirixServerOptions { NodeId = "node-a", Url = new Uri("https://localhost:5001") };
        options.Peers.Add(new SquirixServerPeerOptions { NodeId = "node-a", Url = new Uri("https://localhost:5999") });
    ...
    public void PeerUrlWithPathIsRejected()
    {
        var options = new SquirixServerOptions { NodeId = "node-a", Url = new Uri("https://localhost:5001") };
        options.Peers.Add(new SquirixServerPeerOptions { NodeId = "node-a", Url = new Uri("https://localhost:5001") });
        options.Peers.Add(new SquirixServerPeerOptions { NodeId = "node-b", Url = new Uri("https://localhost:5002/cache") });
