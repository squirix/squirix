...
public sealed class RpcMutationIdempotencyDurabilityOrderingTests : UnitTestBase
{
    private const string OperationId = "0123456789abcdef0123456789abcdef";

    private enum OrderingStep : byte
    {
        Put = 1,
    ...
    public async Task IdempotentMutationAppendsOutcomeBeforeDurabilityCommit()
    {
        ...
        await using var orderingJournal = new OrderingJournal(inner, default);
        ...
        orderingJournal.Trace.AssertExpected();
    ...
    private struct OrderingTrace
    {
        ...
        public void Record(OrderingStep step)
        {
            switch (_count++)
            {
                case 0:
        ...
        public readonly void AssertExpected()
        {
    ...
    private sealed class OrderingJournal : IJournalCoordinator
    {
        ...
        public OrderingJournal(IJournalCoordinator inner, OrderingTrace trace)
        {
        ...
        public OrderingTrace Trace { get; private set; }
        ...
        {
            var trace = Trace;
            trace.Record(OrderingStep.AwaitDurabilityCommit);
            Trace = trace;
