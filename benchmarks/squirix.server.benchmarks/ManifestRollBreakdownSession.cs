...
internal sealed class ManifestRollBreakdownSession : IDisposable
{
    ...
    private State.SnapshotRef? Snapshot { get; }
    ...
    public void WriteDataFile(string targetPath, int encodedLength) => Durability.WriteManifestDataFileBlocking(targetPath, _encodeBuffer.AsSpan(0, encodedLength));
    ...
    public void WritePointer(int manifestIndex)
    {
        ...
        Durability.WriteCurrentPointerBlocking(PointerWriter, pointerBuffer);
    }
    ...
    internal static ManifestRollBreakdownSession Create()
    {
