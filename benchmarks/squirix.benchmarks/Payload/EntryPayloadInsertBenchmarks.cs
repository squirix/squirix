...
public class EntryPayloadInsertBenchmarks : RemoteBenchmarkLifecycleBase
{
    ...
    private string _smallValue = string.Empty;

    /// <summary>Stops the shared cache session and benchmark node.</summary>
    ...
    /// <summary>Inserts small string values through the public client SDK.</summary>
    /// <returns>A task that completes when the batch finishes.</returns>
    ...
    /// <summary>Starts the node and prepares payload strings.</summary>
