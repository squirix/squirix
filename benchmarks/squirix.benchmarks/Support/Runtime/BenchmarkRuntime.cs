...
namespace Squirix.Benchmarks.Support.Runtime;

/// <summary>Process-wide transport settings for remote client benchmarks against local HTTPS gRPC nodes.</summary>
