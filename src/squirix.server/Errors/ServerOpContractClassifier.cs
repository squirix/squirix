...
internal static class ServerOpContractClassifier
{
    ...
    internal static bool IsOperationIdReuseMismatchDetail(string? detail) =>
        ClassifyFailedPreconditionDetail(detail) is ServerFailedPreconditionKind.OperationIdReuseMismatch;
    ...
    private static ServerFailedPreconditionKind ClassifyFailedPreconditionDetail(string? detail)
    {
        ...
        return ServerOpContract.IsOperationIdReuseMismatchMessage(detail) ? ServerFailedPreconditionKind.OperationIdReuseMismatch
            : ServerFailedPreconditionKind.None;
    }
}
