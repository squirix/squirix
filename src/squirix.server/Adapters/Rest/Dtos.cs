...
internal static class Dtos
{
    ...
    internal sealed record RestIncrementResponse
    {
        [JsonConstructor]
    ...
    {
        public HealthReadyDetailsResponse(ulong journalBacklogOps, double? snapshotAgeSeconds, bool snapshotInFlight, HealthReadyDetailSections sections)
        {
