...
/// <summary>Bounded deterministic approximate byte estimate for a live cache entry (v0.7.x). Not exact CLR heap usage.</summary>
/// <typeparam name="T">The cache value type.</typeparam>
internal interface ICacheEntrySizeEstimator<T>
{
    /// <summary>Estimates stored footprint using namespace/key lengths, tags, version/expiration metadata, and typed or counter payload hints.</summary>
