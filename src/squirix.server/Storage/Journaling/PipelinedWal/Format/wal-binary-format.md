# PipelinedWal binary on-disk format

Segment files use the same `.jsqx` naming as JsonFramed WAL. Header discriminates backends.
...
|--------|------|-------|
| 0 | 4 | ASCII `SJRN` |
| 4 | 1 | `2` (binary PipelinedWal; JsonFramed uses version `1`) |
