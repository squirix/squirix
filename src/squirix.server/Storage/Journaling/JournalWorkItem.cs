...
{
    private JournalWorkItem(JournalWorkKind kind, TaskCompletionSource? ack, byte[]? frameBytes, int frameLength, int resetSegmentIndex, ulong resetSequence)
    {
        Kind = kind;
        Ack = ack;
    ...
    internal static JournalWorkItem DurabilityCheckpoint(TaskCompletionSource ack)
    {
        ArgumentNullException.ThrowIfNull(ack);
    ...
    internal static JournalWorkItem MaintenanceBegin(TaskCompletionSource ack)
    {
        ArgumentNullException.ThrowIfNull(ack);
    ...
    internal static JournalWorkItem MaintenanceEnd(TaskCompletionSource ack, int resetSegmentIndex, ulong resetSequence)
    {
        ArgumentNullException.ThrowIfNull(ack);
