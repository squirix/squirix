...
internal sealed class StorageRetentionCleanupReadiness : IRetentionCleanupReadinessStatus
{
    ...
    public StorageRetentionCleanupReadiness(PersistenceOptions options)
    {
    ...
    private bool IsDegradedCore() =>
        _consecutiveWriteFailures >= _consecutiveWriteFailureThreshold || _recentFailures.Count >= _windowFailureThreshold;
