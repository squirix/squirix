...
internal sealed class ClusteredCache<T> : ILogicalNamespacedCache<T>
{
    ...
    public ClusteredCache(string selfId, ILogicalNamespacedCache<T> local, INodeLocator locator, IServerClientPool clients)
    {
    ...
    private sealed class OwnerPeerCacheClient
    {
        ...
        public OwnerPeerCacheClient(IServerClientPool clients)
        {
