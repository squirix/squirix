...
{
    /// <summary>Returns <see cref="ServerCacheNames.DefaultNamespace" /> when the persisted value is null or empty; otherwise returns the persisted string unchanged.</summary>
