...
/// <param name="WireValuePayload">Optional cached binary gRPC payload for <paramref name="Value" />.</param>
/// <typeparam name="T">The cache value type.</typeparam>
public readonly record struct NodeCacheValueResult<T>(bool Found, T? Value, ReadOnlyMemory<byte> WireValuePayload = default);
