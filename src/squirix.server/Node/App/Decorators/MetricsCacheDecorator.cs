...
internal sealed class MetricsCacheDecorator<T> : ILogicalNamespacedCache<T>
{
    ...
    public ValueTask<NodeCacheValueResult<T>> GetValueAsync(string cacheName, string key, CancellationToken cancellationToken) => ObserveAsync(
        cacheName,
    ...
    public ValueTask SetEntryAsync(string operationId, string cacheName, string key, NodeCacheEntry<T> entry, CancellationToken cancellationToken) => ObserveAsync(
        cacheName,
    ...
    public ValueTask<bool> TryAddEntryAsync(string operationId, string cacheName, string key, NodeCacheEntry<T> entry, CancellationToken cancellationToken) => ObserveAsync(
        cacheName,
