...
internal interface IMemoryPressureGate
{
    ...
    /// <param name="magnitudeUnknown">When <see langword="true" />, the net growth cannot be bounded cheaply; policy treats this conservatively at critical pressure.</param>
