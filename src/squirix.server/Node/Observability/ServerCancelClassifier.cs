...
/// <summary>Canonical classification for cancellation and timeout signals expressed through linked <see cref="CancellationToken" /> state.</summary>
/// <remarks>
...
internal static class ServerCancelClassifier
{
    ...
    /// <summary>Returns true when a gRPC <see cref="StatusCode.Cancelled" /> fault should be surfaced as caller cancellation.</summary>
