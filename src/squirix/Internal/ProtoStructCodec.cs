...
internal static class ProtoStructCodec
{
    ...
    internal static T? FromValue<T>(Value value, ISquirixSerializer serializer)
    {
    ...
    internal static object? ToUntypedValue(Value value, ISquirixSerializer serializer) => value.KindCase switch
    {
    ...
    internal static T? Deserialize<T>(Value value, ISquirixSerializer serializer)
    {
...
#pragma warning restore MA0045
    ...
    internal static void WriteValue(Utf8JsonWriter writer, Value value)
    {
    ...
    internal static void WriteStructValue(Utf8JsonWriter writer, Struct structValue)
    {
    ...
    internal static void WriteListValue(Utf8JsonWriter writer, ListValue listValue)
    {
