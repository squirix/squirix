...
/// When <c>options</c> is <see langword="null"/>, the implementation applies the cache-configured default expiration.
/// </remarks>
public interface ICache<T>
{
    ...
    /// <param name="options">Entry options for a produced value. When <see langword="null"/>, the cache-configured default expiration is used.</param>
    /// <param name="cancellationToken">Cancellation token.</param>
