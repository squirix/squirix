...
| `SQUIRIX_CLUSTER_MTLS_ENABLED`                       |Enables inter-node cluster mTLS loading when `true` or `1`. Wiring lands in later tasks.                                                                                                                            |
...
| `SQUIRIX_CLUSTER_MTLS_CA_PATH`                       |PEM-encoded cluster CA / trust root. Required when cluster mTLS is enabled.                                                                                                                                         |
